export default function Contact() {
    return (
        <div className="min-h-screen pt-24 px-4 bg-[#0a0c10]">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <a
                        ...
                        className="group flex flex-col items-center p-8 rounded-2xl bg-white/5 border border-white/5 hover:border-portal-green/50 hover:bg-white/10 transition-all duration-300"
                    >
                        <div className="w-12 h-12 mb-4 text-neutral-400 group-hover:text-portal-green transition-colors">
                        ...
                        <span className="text-neutral-400 group-hover:text-portal-glow transition-colors">Voir mon profil</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-neutral-400 group-hover:text-portal-glow transition-colors">mmarco68650@gmail.com</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-neutral-400 group-hover:text-portal-glow transition-colors">06 23 82 91 84</span>
                    </a>
                </div>
            </div>
        </div>
